...
public class Main {
    ...
    static class ClientHandler implements Runnable {
        ...
        private void handleEcho(BufferedWriter writer, String line)
                throws IOException {
            writer.write("+" + line + "\r\n");
            writer.flush();
        }

    private void handleSet(BufferedWriter writer, String key, String value)
        throws IOException {
            ...
            private void handleGet(BufferedWriter writer, String key)
        throws IOException {
                ...
                while (clientSocket.getInputStream().read(buffer) != -1) {
                    ...
                    List<String> args =
                            Arrays.stream(msg.split("\r\n"))
                                    .filter(arg
                                            -> !arg.trim().isEmpty() && !arg.startsWith("*") &&
                                            !arg.startsWith("$"))
